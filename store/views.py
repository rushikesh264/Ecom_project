...
def store(request):
    ...
    context={'products':products,'cartItems':cartItems,'loginflag':loginflag,'currentpage':'Store'}
...
def cart(request):
    ...
    context={'items':items,'order':order,'cartItems':cartItems,'loginflag':loginflag,'currentpage':'Cart'}
...
def checkout(request):
    ...
    context={'items':items,'order':order,'cartItems':cartItems,'loginflag':loginflag,'currentpage':'Checkout'}
    return render(request,'store/checkout.html',context)
def aboutus(request):
    data = cartData(request)
    cartItems = data['cartItems']
    context={'cartItems':cartItems,'currentpage':'Aboutus'}
...
def viewdetails(request,id):
    ...
    context={'product':product,'cartItems':cartItems,'loginflag':loginflag,'currentpage':'Details'}
    # context={}
...
def userregister(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            print("error")
    context = {'form':form,'cartItems':0,'currentpage':'Registration'}
...
def userlogin(request):
    ...
    context={'cartItems':0,'currentpage':'Login'}
...
def userorder(request):
    ...
    # order = data['order']
    # items = data['items']
    # doneord = data['doneord']
    # doneprod = data['doneprod']
    doneorditem = data['doneorditem']  

    # print("view.py",doneprod)
    context={'loginflag':loginflag,'cartItems':cartItems,'doneorditem':doneorditem,'currentpage':'Your_Orders'}
    print("view.py",doneorditem)
